...
# Start the server
./server &> ./tests_output/test-1-server-1-client-init-server-output.txt &
...
# Start the client
./client set 1 "test" 2 1.4231 2231.0013 &> ./tests_output/test-1-server-1-client-init-client-output.txt &

# Give the client some time to finish
sleep 0.5
./client init &>> ./tests_output/test-1-server-1-client-init-client-output.txt &

# Wait client to finish
wait $!

# Stop the server
./client exit &>>  ./tests_output/test-1-server-1-client-init-client-output.txt &
